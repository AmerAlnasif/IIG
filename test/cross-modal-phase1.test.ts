...
describe('D2 — knobsHash differs across cross-modal knob values', () => {
  ...
  test('KNOBS_HASH_VERSION is 18 (cross-modal still appended; 15→16 detail fold #3515; 16→18 qwen3 query-side instruct)', () => {
    ...
    // 16→18: qi= qwen3 query-side Instruct template (17 = in-flight #3617).
