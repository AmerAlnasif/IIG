...
describe('KNOBS_HASH_VERSION + version invariants', () => {
  test('version is 18 (…; 12→13 embedding-provider migration #3390; 14→15 FTS language; 15→16 detail fold #3515; 16→18 qwen3 query-side instruct)', () => {
    ...
    // 16→18: qi= (qwen3 query-side Instruct template) joins the key
